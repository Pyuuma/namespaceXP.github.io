...
e(i,s),console&&console.error&&n&&console.error(n);
};
}(),setTimeout(function(){
...
},n=encodeURIComponent("res[{res}]; page[{page}]".format(e));
(new Image).src=wx.url("/misc/jslog?content="+n+"&id=59&level=error");
}
});
}(window);;$.fn.extend({
center:function(i){
