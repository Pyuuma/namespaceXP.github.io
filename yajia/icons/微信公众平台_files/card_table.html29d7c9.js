...
var d=o.price,_=o.total_coin_balance;
if(!n){
var p=$(".js_error",s),m=$(".js_total_price",s),f=$(".js_total_price_container",s),h=$(".js_value",s).keyup(function(){
var t=$(this),e=$.trim($(this).val());
if(!/^[0-9]+$/.test(e)||isNaN(e)||0>=e)return p.text("库存必须是不小于1的整数").show().addClass("fail"),
t.focus(),f.hide(),!1;
var a=1e9;
return e>=a?(p.text("库存不能大于10亿").show().addClass("fail"),t.focus(),!1):d*e>_?(p.html('券点余额：%s 余额不足，<a target="_blank" href="%s">去充值</a>'.sprintf(_/100,wx.url("/merchant/cardmoneymgr?action=get_order_flow"))).show().addClass("fail"),
t.focus(),f.show(),m.text(d*e/100),!1):(p.text("券点余额：%s，优先使用免费券点".sprintf(_/100)).show().removeClass("fail"),
f.show(),void m.text(d*e/100));
});
...
h.focus(),f.hide(),!1;
var a=1e9;
return t>=a?(p.text("库存不能大于10亿").show().addClass("fail"),h.focus(),!1):d*t>_?(p.html('券点余额：%s 余额不足，<a target="_blank" href="%s">去充值</a>'.sprintf(_/100,wx.url("/merchant/cardmoneymgr?action=get_order_flow"))).show().addClass("fail"),
h.focus(),!1):($(this).btn(!1),t=parseInt(t),void e.get({
...
success:function(t){
$(this).btn(!0),0==t.base_resp.ret?(t.addquantity=o.quantity,l(3,t)):26==t.base_resp.ret?(t.is_fail=!1,
l(4,t)):(t.is_fail=!0,l(4,t));
}
}));
}),$(".js_cancel",s).click(function(){
c.tooltip.hide(),r.removeAll(),c.tooltip=null;
...
var v=o.addquantity;
a.suc("设置库存成功"),setTimeout(function(){
r.removeAll(),t.quantityChange&&t.quantityChange.call(c,u,v);
},1500);
}else 4==i||7==i?n||$(".js_close_quantity",s).click(function(){
r.removeAll();
}):5==i?n||$(".js_go_activate",s).click(function(){
...
var d,u=$(this).data("cid");
if(t.before&&t.before(u)===!1)return!1;
var _=t.data;
if(t.cache_card&&(_=t.cache_card[u]),_.is_sns_card&&3!=_.status&&5!=_.status&&6!=_.status)return a.err("审核中的朋友的券无法修改库存"),
!1;
if(_.is_sns_card){
c.tooltip=new n({
container:this,
...
c.tooltip.$dom.css("top",p-($(document.body).scrollTop()||0)),s.stopPropagation();
}else{
var m=new n({
container:this,
content:o({
...
type:"btn_primary",
click:function(){
var o=m.$dom,s=o.find(".js_value"),n=parseInt($.trim(s.val()));
...
if(0==o.base_resp.ret)a.suc("设置库存成功"),r.removeAll(),t.quantityChange&&t.quantityChange.call(c,u,!t.setquantity||d.value()?n:-n);else if(10039==o.base_resp.ret){
...
m.show(),r.removeAll(),r.add(m),$(".popover").css({
"z-index":"10000",
width:"326px"
}),d=m.$dom.find(".js_quantity_type").checkbox(),m.$dom.find(".js_value").focus();
var p=parseInt(m.$dom.css("top"))||0;
m.$dom.css("top",p-($(document.body).scrollTop()||0)),s.stopPropagation();
}
});
};
return c;
