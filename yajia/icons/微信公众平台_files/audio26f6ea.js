...
function s(e){
var _=/^https?:\/\/mp.weixin.qq.com\/s/,t=/^http:\/\/mp.weixin.qq.com\/bizmall\/cardshelf/,s=/^http:\/\/mp.weixin.qq.com\/bizmall\/mallshelf/;
return _.test(e)?1:t.test(e)?2:s.test(e)?3:4;
}
function i(e){
return e?(e+"").html(!1):"";
}
...
return 4==t?_.replace("http://",""):i(_);
}
function n(e){
var n={},e=_(e);
if(!e)return null;
r(n,e),r(n,e.base_info);
var a=e.base_info.date_info||{};
n.time_type=p[a.type]||a.type,1==n.time_type&&(n.begin_time=a.begin_timestamp,n.end_time=a.end_timestamp),
n.from_day=a.fixed_begin_term||0,n.fixed_term=a.fixed_term||30,n.quantity=e.base_info.sku.quantity,
...
f.url_type=s(f.url),f.url=o(f),d=[f];
}
e.custom_cell1&&(e.custom_cell1.url_type=s(e.custom_cell1.url),e.custom_cell1.url=o(e.custom_cell1),
d.push(e.custom_cell1)),e.custom_cell2&&(e.custom_cell2.url_type=s(e.custom_cell2.url),
...
n.require_keywords=u.flag2info(y.info_flag),n.option_keywords=u.flag2info(b.info_flag),
n.require_self_keywords=y.field_list,n.option_self_keywords=b.field_list,n.must_activate=!n.auto_activate,
...
var g=e.base_info;
if(10==n.type)var T=e.modify_msg_operation||{
_notexist:!0
};else var T=g.consume_msg_operation||{
_notexist:!0
};
n.msg_operation=T.url_cell||T.card_cell||{
_notexist:!0
},n.msg_operation._notexist||(n.msg_operation._type=n.msg_operation.card_id?5:s(n.msg_operation.url),
n.msg_operation.url&&(n.msg_operation.url=i(n.msg_operation.url))),n.msg_operation.endtime=n.msg_operation.end_time,
...
g.sub_merchant_info&&(n.sub_merchant_id=g.sub_merchant_info.merchant_id);
var h=e.advanced_info;
if(h){
n.is_sns_card=1==h.gen_type,n.time_limit=h.time_limit||[],n.text_image_list=h.text_image_list||[],
n.consume_share_self_num=h.consume_share_self_num,n.consume_share_self_num>0?(n.consume_is_share=!0,
n.consume_share_type=1):h.consume_share_card_list&&h.consume_share_card_list.length?(n.consume_is_share=!0,
n.consume_share_type=2,n.consume_share_card_id=h.consume_share_card_list[0].card_id):n.consume_is_share=!1,
n.business_service=h.business_service;
var E=h.abstract;
E&&($(".section_card_intro").show(),n.abstract=E.abstract,n.cover_logo=E.icon_url_list?E.icon_url_list[0]:"");
}
return n.is_quit_money=n.func_flag&1<<22,n.can_edit_quantity=!(n.is_quit_money||10==n.type||n.is_from_intercomm||(3!=n.status&&5!=n.status&&6!=n.status||!n.is_sns_card||n.is_expire)&&n.is_sns_card),
n.is_sns_card&&(n.isnew=!0),n.isnew||(n.quantity="--"),n;
}
function r(e,_){
...
removeOnHide:!0
}),n=(e("common/wx/Step.js"),function(e){
...
function r(){
a.save();
var e=$("#jsVoteDate").val().split("-").concat([$("#jsVoteHour").data("val"),$("#jsVoteMin").data("val")]).join(""),e=g(e,"YYYYMMDDHHmm").unix(),t=window.wx.data.time;
...
{
var s=e("tpl/vote/vote.html.js"),u=e("tpl/vote/vote_question.html.js"),d=(e("tpl/vote/vote_item.html.js"),
e("biz_web/ui/checkbox.js"),e("common/lib/datepicker.js"),e("biz_web/ui/dateRange.js"),
e("biz_web/ui/dropdown.js")),p=e("common/wx/upload.js"),g=(e("common/wx/media/imageDialog.js"),
e("biz_common/moment.js")),c=(e("common/qq/mask.js"),e("common/wx/Tips.js")),m=(e("biz_common/jquery.validate.js"),
...
});define("common/wx/mpEditor/editor_all_min.js",["biz_web/lib/store.js","tpl/mpEditor/layout.html.js"],function(require,exports,module){
...
var store=require("biz_web/lib/store.js"),baidu=window.baidu||{};
...
var n=0;
if(i.ie&&(n=parseFloat(e.match(/msie (\d+)/)[1]),i.ie9Compat=9==document.documentMode,
...
i.ie6Compat=7>n||i.quirks),i.gecko){
var o=e.match(/rv:([\d\.]+)/);
...
n=n||window;
var o=n.document;
i&&t.push(i),"complete"===o.readyState?e(o):(o.isReady&&e(o),browser.ie?(!function(){
if(!o.isReady){
try{
...
cssRule:browser.ie?function(e,t,i){
var n,o;
...
var t,n=this;
n.document=e,ie&&(t=domUtils.getWindow(e).frameElement,domUtils.on(t,"beforedeactivate",function(){
...
var e,t,i,n,o=ie?this.getIERange():this.getRange();
if(ie){
...
getText:function(){
var e,t;
return this.isFocus()&&(e=this.getNative())?(t=browser.ie?e.createRange():e.getRangeAt(0),
browser.ie?t.text:t.toString()):"";
},
clearRange:function(){
...
browser.ie||domUtils.on(i.window,["blur","focus"],function(e){
if("blur"==e.type){
...
var n=this;
e="number"==typeof e?e+"px":e,e!==parseInt(this.iframe.parentNode.style.height)&&(i?$(this.iframe).parent().animate({
height:e
},1e3,"easeOutCubic",function(){
n.fireEvent("heightChanged");
}):$(this.iframe).parent().finish().height(e)),!t&&(this.options.minFrameHeight=this.options.initialFrameHeight=e),
this.body.style.height=e,this.fireEvent("heightChanged");
},
...
this.fireEvent("funcPvUvReport",e+t);
...
r=i.document.getElementById("_img_parent_tmp"),r.removeAttribute("id"),r=r.firstChild,
n.selectNode(r).select(),a=r.parentNode.nextSibling,a&&domUtils.isEmptyNode(a)&&domUtils.remove(a);
}
}
}
},
...
this.fireEvent("funcPvUvReport",n),o=o||(this.queryCommandState(n)?"none":"underline"==n?"underline":"fontborder"==n?"1px solid #000":"line-through");
...
this.fireEvent("funcPvUvReport",e);
...
this.fireEvent("funcPvUvReport",t);
...
execCommand:function(e,t,i){
return this.fireEvent("funcPvUvReport",e+i),this.execCommand("paragraph","p",{
style:"margin-"+i+":"+t+"px"
}),!0;
},
...
execCommand:function(e,t){
return this.fireEvent("funcPvUvReport",e),this.execCommand("paragraph","p",{
...
var r="";
if(n.collapsed)r=browser.ie?browser.version>8?"":"&nbsp;":"<br/>";else{
...
if(browser.ie&&browser.version>8)"element"==e.type?"br"==e.tagName?r+="\n":dtd.$empty[e.tagName]||(utils.each(e.children,function(t){
"element"==t.type?"br"==t.tagName?r+="\n":dtd.$empty[e.tagName]||(r+=t.innerText()):r+=t.data;
}),/\n$/.test(r)||(r+="\n")):r+=e.data+"\n",!e.nextSibling()&&/\n$/.test(r)&&(r=r.replace(/\n$/,""));else if(browser.ie)"element"==e.type?"br"==e.tagName?r+="<br>":dtd.$empty[e.tagName]||(utils.each(e.children,function(t){
...
this.fireEvent("funcPvUvReport",e),i||(i="insertorderedlist"==e.toLowerCase()?"decimal":"disc");
...
for(var I,_=a.createBookmark(),R=domUtils.getNextDomNode(_.start,!1,d),L=a.cloneRange(),A=domUtils.isBlockElm;R&&R!==_.end&&domUtils.getPosition(R,_.end)&domUtils.POSITION_PRECEDING;)if(3==R.nodeType||dtd.li[R.tagName]){
if(1==R.nodeType&&dtd.$list[R.tagName]){
for(;R.firstChild;)u.appendChild(R.firstChild);
I=domUtils.getNextDomNode(R,!1,d),domUtils.remove(R),R=I;
continue;
}
for(I=R,L.setStartBefore(R);R&&R!==_.end&&(!A(R)||domUtils.isBookmarkNode(R));)I=R,
R=domUtils.getNextDomNode(R,!1,null,function(e){
return!l[e.tagName];
});
R&&A(R)&&(p=domUtils.getNextDomNode(I,!1,d),p&&domUtils.isBookmarkNode(p)&&(R=domUtils.getNextDomNode(p,!1,d),
I=p)),L.setEndAfter(I),R=domUtils.getNextDomNode(I,!1,d);
var D=a.document.createElement("li");
if(D.appendChild(L.extractContents()),domUtils.isEmptyNode(D)){
for(var I=a.document.createElement("p");D.firstChild;)I.appendChild(D.firstChild);
D.appendChild(I);
}
u.appendChild(D);
}else R=domUtils.getNextDomNode(R,!0,d);
a.moveToBookmark(_).collapse(!0),h=r.document.createElement(c),o(h,i),h.appendChild(u),
a.insertNode(h),n(h,c,i);
for(var w,U=0,M=domUtils.getElementsByTagName(h,"div");w=M[U++];)w.getAttribute("tmpDiv")&&domUtils.remove(w,!0);
...
var e=this;
browser.webkit&&e.addListener("click",function(t,i){
if("IMG"==i.target.tagName){
var n=new dom.Range(e.document);
...
function e(e){
var t=this;
clearTimeout(s),a||(s=setTimeout(function(){
(!t.queryCommandState||t.queryCommandState&&1!=t.queryCommandState("source"))&&(n||(n=t.document.createElement("span"),
n.style.cssText="display:block;width:0;margin:0;padding:0;border:0;clear:both;",
n.innerHTML="."),o=n.cloneNode(!0),t.body.appendChild(o),r=Math.max(domUtils.getXY(o).y+o.offsetHeight,Math.max(d.minFrameHeight,d.initialFrameHeight)),
("firstfocus"==e||"adjustheight"==e||r!=l)&&(t.setHeight(r,!0,"firstfocus"==e),l=r),
domUtils.remove(o));
},50));
}
var t=this;
if(t.autoHeightEnabled=t.options.autoHeightEnabled!==!1,t.autoHeightEnabled){
var i,n,o,r,s,a,l=0,d=t.options;
...
t.addListener("adjustheight afterinserthtml keyup mouseup",e),t.addListener("firstfocus",e),
...
V=!1,j=0,N(t))),it&&at)return j=0,H.body.style.webkitUserSelect="none",H.selection.getNative()[browser.ie?"empty":"removeAllRanges"](),
...
function v(e){
browser.ie&&(e=C(e)),y(),V=!0,q=setTimeout(function(){
N(e);
},Y);
}
function b(e,t){
...
i.selection.getNative()[browser.ie?"empty":"removeAllRanges"](),j=0,st=i.document.getElementById("ue_tableDragLine");
...
var o=G(tt);
if(et!=tt){
i.document.body.style.webkitUserSelect="none",i.selection.getNative()[browser.ie?"empty":"removeAllRanges"]();
...
var H=this,q=null,$=null,F=5,V=!1,W=5,z=10,j=0,X=null,Y=360,K=UE.UETable,G=function(e){
...
return d.innerHTML=s.html,void(s.html=d[browser.ie?"innerText":"textContent"]);
}
var c=Q(a);
if(e){
...
e.setAttribute("width",Math.floor(P(H,dt,J(H))));
});
}
});
var u=H.execCommand;
...
editor:t
}),e.render(),e.showAt(a),t.fireEvent("aftershowcontextmenu",e),domUtils.preventDefault(s),
browser.ie){
var m;
try{
...
}),"contextmenu"==t&&(domUtils.preventDefault(n),browser.ie)){
var s;
try{
...
i.fireEvent("funcPvUvReport","formatmatch");
...
n[me.options.catchFieldName]=encodeURI(decodeURIComponent(i)),n.t="ajax-editor-upload-img",
ajax.request(catcherUrl,n);
}
...
var me=this;
this.setOpt({
localDomain:["127.0.0.1","localhost","mmbiz.qpic.cn","mmbiz.qlogo.cn","m.qpic.cn",/^http\:\/\/(a|b)(\d)+\.photo\.store\.qq\.com/g],
...
n="img"==s.tagName.toLowerCase()?[s]:domUtils.getElementsByTagName(s,"img");
for(var c,u=0;c=n[u++];)r=c.getAttribute("_src")||c.src||"",me.fireEvent("catchRemoteImage",[c],"img",r),
l=!0;
for(a=[s],a.push.apply(a,domUtils.getElementsByTagName(s,"*")),u=0;c=a[u++];)o=c.getAttribute("style")||"",
o=c.style.cssText||"",o=o.match(/;?\s*(background|background-image)\s*\:[^;]*?url\(([^\)]+)\)/),
...
i?(this._saveColor(i),this.fireEvent("pickcolor",i)):this._onPickNoColor();
},
...
},r=["undo","redo","formatmatch","bold","italic","underline","fontborder","blockquote","pasteplain","selectall","horizontal","removeformat",,"insertparagraphbeforetable","insertrow","insertcol","mergeright","mergedown","deleterow","deletecol","splittorows","splittocols","splittocells","mergecells","deletetable"],s=0;n=r[s++];)n=n.toLowerCase(),
t[n]=function(e){
return function(i){
var n=new t.Button({
...
i.enableScale()):i.disableScale(),t.options.elementPathEnabled||t.options.wordCount||t.options.scaleEnabled||(t.ui.getDom("elementpath").style.display="none",
t.ui.getDom("wordcount").style.display="none",t.ui.getDom("scale").style.display="none"),
...
queryAutoHide:function(e){
return e&&e.ownerDocument==t.document&&("img"==e.tagName.toLowerCase()||o.findParentByTagName(e,"a",!0))?e!==a.anchorEl:baidu.editor.ui.Popup.prototype.queryAutoHide.call(this,e);
}
});
a.render(),t.addListener("handle_common_popup",function(e,t,i){
i&&t?(a.getDom("content").innerHTML=a.formatHtml(i),a.anchorEl=t,a.showAnchor(a.anchorEl)):a.hide();
});
},
