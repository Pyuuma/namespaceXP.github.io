define("common/wx/preview.js",["common/wx/Tips.js","widget/img_preview.css","tpl/preview.html.js"],function(t,i,n){
"use strict";
...
_initEvent:function(){
var t=this;
$("#preview_container").on("click",function(i){
var n=i.srcElement||i.target;
$.contains($("#img_container")[0],n)||$.contains($("#img_opr_container")[0],n)||t._destory();
}),$("#closebtn").on("click",function(){
t._destory();
}),$("#btnview").on("click",function(){
""!=t._moCfg.imgsrc?window.open(t._moCfg.imgsrc):e.err("图片资源加载失败。");
}),$("#btnnext").on("click",function(){
t._next();
}),$("#btnprev").on("click",function(){
t._prev();
}),$(document).keyup(function(i){
27==i.keyCode&&t._destory(),37==i.keyCode&&t._prev(),39==i.keyCode&&t._next();
}),$("#img_dom").find("img").on("load",function(){
$("#img_dom").show(),$("#loading_dom").hide();
});
},
_inArray:function(t,i){
for(var n,e=0;n=i[e];e++)if(t==n.imgsrc)return e;
return-1;
}
},n.exports={
close:function(){
...
"use strict";
var i=e("common/wx/Cgi.js"),t=e("common/wx/Tips.js"),o=(e("common/wx/popup.js"),
e("common/wx/pagebar.js")),n=e("biz_web/utils/upload.js"),a=e("common/wx/tooltips.js"),r=e("tpl/media/dialog/image_layout.html.js"),s=e("tpl/media/dialog/image_list.html.js"),l=e("tpl/media/dialog/image_group.html.js"),d=e("tpl/media/dialog/image_water.html.js"),g=(template.render,
template.compile(l)),p=template.compile(s);
...
});define("media/appmsg_edit_v2.js",["biz_web/ui/jquery.scrollbar.js","common/qq/Class.js","biz_web/utils/upload.js","biz_web/ui/checkbox.js","common/wx/inputCounter.js","common/wx/Step.js","biz_web/ui/dropdown.js","common/wx/tooltips.js","biz_common/jquery.validate.js","common/wx/Tips.js","biz_common/moment.js","common/wx/media/imageDialog.js","common/wx/preview.js","common/wx/mpEditor/plugin/music.js","common/wx/mpEditor/plugin/vote.js","common/wx/mpEditor/plugin/card.js","common/wx/mpEditor/plugin/link.js","common/wx/mpEditor/plugin/unlink.js","common/wx/mpEditor/plugin/audio.js","common/wx/mpEditor/plugin/img.js","common/wx/mpEditor/plugin/video.js","common/wx/mpEditor/editor.js","tpl/media/appmsg_edit/article.html.js","media/article_list.js","media/media_static_data.js","media/report.js","common/wx/ban.js"],function(e){
"use strict";
function i(e,i,t){
...
var t=e("common/qq/Class.js"),s=e("biz_web/utils/upload.js"),n=(e("biz_web/ui/checkbox.js"),
e("common/wx/inputCounter.js")),o=e("common/wx/Step.js"),r=e("biz_web/ui/dropdown.js"),a=e("common/wx/tooltips.js"),d=e("biz_common/jquery.validate.js").rules,c=e("common/wx/Tips.js"),l=e("biz_common/moment.js"),_=e("common/wx/media/imageDialog.js"),p=e("common/wx/preview.js"),h=e("common/wx/mpEditor/plugin/music.js"),u=e("common/wx/mpEditor/plugin/vote.js"),m=e("common/wx/mpEditor/plugin/card.js"),f=e("common/wx/mpEditor/plugin/link.js"),g=e("common/wx/mpEditor/plugin/unlink.js"),j=e("common/wx/mpEditor/plugin/audio.js"),w=e("common/wx/mpEditor/plugin/img.js"),b=e("common/wx/mpEditor/plugin/video.js"),v=e("common/wx/mpEditor/editor.js"),x=e("tpl/media/appmsg_edit/article.html.js"),y=e("media/article_list.js"),k=e("media/media_static_data.js"),E=e("media/report.js"),C=k.URL_PLATFORM_MAP,q=k.article_type,L=e("common/wx/ban.js"),z=wx.cgiData;
!function(e){
...
{
var D=Math.random(),I=t.declare({
init:function(e){
var i=this;
i.opt=e,$.extend(!0,i,e),i.$editor=$(i.editor_selector).html(wx.T(x,{
...
s&&s.find(".appmsg_title a").html(t||"标题"),i.find(".js_title_error").hide(),$("#js_draft_tips").hide();
}).on("focus",function(){
...
$(this).hasClass("js_author")?new n(this,{
...
onComplete:function(i,s,n,o){
if(!o.base_resp||0==o.base_resp.ret){
var r=o.content,a=wx.url("/cgi-bin/getimgdata?mode=large&source=file&fileId=%s".sprintf(r));
t.find(".js_cover").find("img").remove(),t.find(".js_cover").show().prepend('<img src="%s">'.sprintf(a)).find("input").val(r);
var d=e.articleList.$current;
d&&(d.find("img.js_appmsg_thumb").attr("src",a),d.addClass("has_thumb")),t.find(".js_cover_error").hide();
}
}
}),$("#js_imagedialog").on("click",function(){
document.body.style.overflow=document.documentElement.style.overflow="hidden",_({
scene:"biz",
maxSelect:1,
desc:"建议尺寸：900像素 * 500像素",
onOK:function(s){
var n=s[0].file_id,o=wx.url("/cgi-bin/getimgdata?mode=large&source=file&fileId=%s".sprintf(n));
t.find(".js_cover").find("img").remove(),t.find(".js_cover").show().prepend('<img src="%s">'.sprintf(o)).find("input").val(n);
var r=e.articleList.$current;
r&&(r.find("img.js_appmsg_thumb").attr("src",o),r.addClass("has_thumb")),t.find(".js_cover_error").hide(),
i(38,1,"trace"),this.destroy(),document.body.style.overflow=document.documentElement.style.overflow="auto";
},
onCancel:function(){
this.destroy();
},
...
var e=this,i=[],t=["undo","redo","|","fontsize","|","blockquote","horizontal","|","removeformat","formatmatch"],s=["bold","italic","underline","forecolor","backcolor","|","justifyleft","justifycenter","justifyright","justifyjustify","|","rowspacingtop","rowspacingbottom","lineheight","|","insertorderedlist","insertunorderedlist","|","imagenone","imageleft","imageright","imagecenter"];
i.push(new w({
container:"#js_editor_insertimage"
})),i.push(new b({
container:"#js_editor_insertvideo"
})),wx.cgiData.can_use_vote&&i.push(new u({
container:"#js_editor_insertvote"
})),wx.cgiData.can_use_card&&i.push(new m({
container:"#js_editor_insertcard",
biz_uin:z.biz_uin
})),wx.cgiData.qqmusic_flag&&i.push(new h({
container:"#music_plugin_btn"
})),wx.cgiData.can_use_voice&&i.push(new j({
container:"#audio_plugin_btn"
})),(wx.cgiData.can_use_copyright||wx.cgiData.can_use_hyperlink||wx.cgiData.is_link_white)&&(i.push(new f),
i.push(new g),t.push("link","unlink"));
var n=e.ueditor=new v({
plugins:i,
autoHeightEnabled:!0,
topOffset:53,
toolbars:[t,s]
...
c.suc("内容已上传完成");
}),n.addListener("catchremotesuccess",function(i,t,s,o,r,a){
var d=n.getDocument(),c=d.getElementById(t);
if(null!=c){
var l={
src:o
};
...
}),n.addListener("catchremoteerror",function(i,t,s){
var o=n.getDocument(),r=o.getElementById(t);
if(null!=r){
"img"==s?$(r).css({
width:"497px",
height:"auto"
...
var i=n.getDocument(),t=$(i).find(".js_catchremoteimageerror").length;
t>0?$(".js_catch_tips",e.$editor).show().find(".js_msg_content").text("有%s张图片粘贴失败".sprintf(t)):$(".js_catch_tips",e.$editor).hide();
...
""==n.getUeditor().getContent()?n.getUeditor().setHeight("auto",!0):setTimeout(function(){
n.fireEvent("adjustheight");
},50);
}),n.ready(function(){
e._initEditArea(),e.articleList=new y($.extend({
maxNum:8,
ueditor:e.ueditor,
...
type:"primary",
click:function(){
d.find(".js_step_panel").hide().eq(1).show();
var e=new r({
container:"#js_original_article_type",
label:"请选择",
data:q
});
e.selected(t.find(".js_classify").text()),d.find(".js_btn_p").eq(0).hide(),d.find(".js_btn_p").eq(1).show(),
d.find(".js_btn_p").eq(2).show(),c.setStep(2);
}
},{
text:"上一步",
click:function(){
d.find(".js_step_panel").hide().eq(0).show(),d.find(".js_btn_p").eq(0).show(),d.find(".js_btn_p").eq(1).hide(),
d.find(".js_btn_p").eq(2).hide(),c.setStep(1);
}
},{
text:"确定",
type:"primary",
click:function(){
e._checkOriginal(d)&&($(".js_original_type").hide().eq(1).show(),$(".js_original_content").show(),
...
"checked"==d.find(".js_forIEbug_frm").attr("checked")?($("#js_pay").checkbox("disabled",!0),
...
d.find(".js_btn_p").eq(1).hide(),d.find(".js_btn_p").eq(2).hide();
var c=new o({
container:d.find(".js_step"),
selected:1,
names:["1 须知","2 原创声明信息"]
});
d.find(".js_original_publish").checkbox({
multi:!1,
onChanged:function(e){
d.find(".js_platform").parent().hide().eq(e.val()).show(),d.find(".js_url").attr("placeholder",+e.val()?"选填":"该原创文章在其他网站的地址").trigger("blur");
}
...
}),d.on("input propertychange blur",".js_url",function(){
if(1!=d.find(".js_original_publish:checked").val()){
var e=$.trim($(this).val()),i=e.match(/^(https?:\/\/)?((([\da-z]+\.)+)?(([\da-z]+)\.[\da-z]+))/),t="";
i&&(t=t||C[i[5]],t=t||C[i[2]],t=t||i[6]),t&&$(this).closest(".js_step_panel").find(".js_platform").eq(0).val(t).trigger("keyup");
}
}),d.on("keyup",".js_platform,.js_url,.js_author",function(){
...
i.find(".js_reward").checkbox("disabled",!0),i.find(".js_reward").checkbox("checked",!1),
i.find(".js_reward_div").hide(),i.find(".js_reward_wording").val(),$("#js_pay",i).checkbox("disabled",!0),
$("#js_pay",i).checkbox("checked",!1),$(".js_pay_tips",e.$editor).show().text("（只有“禁止转载”的原创文章才可以设置付费阅读）"),
$(".js_pay_setting",i).hide();
}),$("#js_original_detail").on("click",function(){
$(this).parent().toggleClass("open"),$(this).siblings("ul").toggle();
});
var t=!0,s=z.orginal_apply_stat,d=1==z.has_invited_original?"/acct/copyrightapply?action=apply":"/acct/selfapply?action=apply";
d=wx.url(d);
...
0==s&&window.open(d),t&&(t=!1,setTimeout(l,2e3));
});
},
_initPay:function(){
...
type:"primary",
click:function(){
var t=e.freeUEditor.val(),n=s.find(".js_fee").val();
return""==t?void c.err("免费区域不能为空"):d.rangelength(t,[20,200])?!n||!/^\d*(\.\d+)?$/.test(n)||n.toString().match(/\.\d{3,}/)||.01>n?void c.err("请输入正确的金额"):.01>n?void c.err("金额必须大于零"):n>200?void c.err("金额不能超过200元"):(s.find(".js_content").html(t),
s.find(".js_content_count").text(e.ueditor.getUeditor().getContent().text().length),
s.find(".js_fee_preview").text(parseFloat(n).toFixed(2)),s.find(".js_nickname").text(wx.data.nick_name),
s.find(".js_title").text($.trim($(".js_title",i).val())),s.find(".js_author").text($.trim($(".js_author",i).val())),
s.find(".js_date").text(l().format("YYYY-MM-DD")),s.find(".js_step_panel").hide().eq(1).show(),
s.find(".js_btn_p").hide(),s.find(".js_btn_p").eq(2).show(),s.find(".js_btn_p").eq(3).show(),
s.find(".js_preview").scrollTop(1e8),r.setStep(2),void this.resetPosition()):void c.err("正文字数要多于20字且不能超过200字");
}
},{
text:"上一步",
click:function(){
s.find(".js_step_panel").hide().eq(0).show(),s.find(".js_btn_p").hide(),s.find(".js_btn_p").eq(0).show(),
s.find(".js_btn_p").eq(1).show(),r.setStep(1),this.resetPosition();
}
},{
text:"确定",
type:"primary",
...
return e.freeUEditor=s.find(".js_editor"),new n(e.freeUEditor,{
minLength:20,
maxLength:200
...
}),t.popup("resetPosition"),t._step=r,t;
},
...
i=!1):e.find(".js_author_error").hide(),0!=s&&!n||d.url(n)||$(".js_forIEbug_selectedTure").hasClass("selected")?e.find(".js_url_error").hide():(e.find(".js_url_error").show(),
i=!1),1!=s||""==n||d.url(n)?e.find(".js_url_error").hide():(e.find(".js_url_error").show(),
i=!1),$(".js_forIEbug_selectedTure").hasClass("selected")&&!$(".js_forIEbug_selectedFalse").hasClass("selected")&&(o="微信公众平台"),
d.rangelength(o,[1,10])||$(".js_forIEbug_selectedTure").hasClass("selected")||!$(".js_forIEbug_selectedFalse").hasClass("selected")?e.find(".js_platform_error").hide():(e.find(".js_platform_error").show(),
i=!1);
for(var c=!1,l=0;l<q.length;l++)a==q[l].name&&(c=!0);
if(0==c?(e.find(".js_article_type_error").show(),i=!1):e.find(".js_article_type_error").hide(),
i){
var _=$("#js_original");
...
i.btn(!0),c.suc("保存成功"),window.history&&history.replaceState?history.replaceState(history.state,document.title,wx.url("/cgi-bin/appmsg?t=media/appmsg_edit&action=edit&type=10&appmsgid=%s".sprintf(e.appMsgId))):1==z.isNew&&(location.href=wx.url("/cgi-bin/appmsg?t=media/appmsg_edit&action=edit&type=10&appmsgid=%s".sprintf(e.appMsgId)));
});
}),$("#js_submit_close").on("click",function(){
var i=$(this);
e.articleList.save(i,function(){
c.suc("保存成功"),window.close();
});
}),$("#js_send").on("click",function(){
var i=$(this);
e.articleList.save(i,function(i){
e.articleList.draft.isDropped=!0,location.href=wx.url("/cgi-bin/masssendpage?t=mass/send&type=10&appmsgid=%s".sprintf(i.appMsgId));
});
}),$("#js_preview").on("click",function(){
if(L(z.func_ban_info,"preview")){
var i=$(this);
e.articleList.save(i,function(){
i.btn(!0),c.remove(),e.articleList.draft.isDropped=!0,e.articleList.preview();
});
}
});
var i=$(".main_hd").offset().top,t=$(".main_hd").height();
$(window).on("scroll",function(){
var e=$(window).scrollTop(),s=$(".main_bd").offset().top,n=$(".main_bd").height(),o=$(window).height(),r=Math.min(n-e+s-t,o-t);
e>i?($("body").addClass("edit_fixed"),$(".js_aside").height(r).find(".js_scrollbar").css("max-height",r)):($("body").removeClass("edit_fixed"),
$(".js_aside").height(n)),setTimeout(function(){
...
var s=$(window).width();
1200>s&&$("#body").width(s).css("margin-left","0"),$(window).on("resize",function(){
var e=$(window).width();
