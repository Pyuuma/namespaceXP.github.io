    ...
    function r() {
        if ("over" != y && "pass" != y) {
            ...
            if ("shooting" == y) {
                ...
                T ? (e = w * D(T.a), e = w * A(T.a) + n.sqrt(4 * p * p - e * e), a(t, e), y = "over", c.save(), stop(), setTimeout(l, 1e3)) : 1 > e ? a(t, u) : (q.push(i(t - z)), o(t), y = "idle", j || (y = "pass", ("jfcz-data", '{"aa":' + (F + 1) + "}"), c.save(), level3366Fn(F), setTimeout(l, 1e3)))
            }
