...
var header_fontsize = 3.6;
var contact_height = 32;
var lineheight_rate = 1.8; 
var goto_lineheight_rate = 3.6; 
var language_height = 9.6;
var copyright_height = 2;
var chosen = 1;
var language = 1;
var language_now_width = 13;
var change_language_innerwidth = 2;
var change_language_height = 16;
...
function set_header(){
	...
	$('#goto').css('font-size', (header_fontsize * width).toString() + 'px');
	$('#goto').css('line-height', (header_fontsize * goto_lineheight_rate * width).toString() + 'px');
...
function set_change_language(){
	...
	$('#contact').css('height', (contact_height * width).toString() + 'px');
	$('#contact_title').css('font-size',(3.8 * width).toString() + 'px');
	$('#contact_address').css('font-size',(2.8 * width).toString() + 'px');
	$('#copyright').css('height',(copyright_height * width).toString() + 'px');
	...
	$('#curve').css('bottom', (language_height * width).toString() + 'px');
	...
	$('#change_img').css('bottom', ((language_height * width - $('#change_img').height()) / 2).toString() + 'px');
	
	$('#language_now').css('height', (parseInt($('#curve').css('bottom')) * 0.29).toString() + 'px');
	$('#language_now').css('width', (language_now_width * width).toString() + 'px');
	...
	$('#change_language').css('height', (change_language_height * width).toString() + 'px');
	$('#change_language').css('width', (2 * change_language_innerwidth * width + language_now_width * width + $('#change_img').height() + $('#language_img').height()).toString() + 'px');
	
	$('#another_change_img').css('height', $('#change_img').height().toString() + 'px');
	$('#another_change_img').css('right', (change_language_innerwidth * width).toString() + 'px');
	$('#another_change_img').css('bottom', (((change_language_height  * width / 2) - $('#change_img').height()) / 2).toString() + 'px');
...
$('#cover').click(function(){
	if("undefined" != typeof(stop_video) && this.style.zIndex == 4){
		stop_video();
	}
